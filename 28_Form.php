...
<head>
    ...
    <!-- <link rel="stylesheet" herf=""style.class> -->
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/php_tutorial/28_Form.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //     <strong>Success!</strong> Database has been connceted successfully!
